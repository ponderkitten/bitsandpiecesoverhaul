...
import net.mcreator.fnafbitsandpieces.network.PosePage0ButtonMessage;
...
public class PosePage0Screen extends AbstractContainerScreen<PosePage0Menu> {
	private final static HashMap<String, Object> guistate = PosePage0Menu.guistate;
	...
	public PosePage0Screen(PosePage0Menu container, Inventory inventory, Component text) {
	...
	private static final ResourceLocation texture = new ResourceLocation("fnaf_bits_and_pieces:textures/screens/pose_page_0.png");
	...
	protected void renderBg(PoseStack ms, float partialTicks, int gx, int gy) {
		...
		RenderSystem.setShaderTexture(0, new ResourceLocation("fnaf_bits_and_pieces:textures/screens/bookpose0.png"));
	...
	public void init() {
		...
		button_yoink = new Button(this.leftPos + 135, this.topPos + -4, 51, 20, Component.translatable("gui.fnaf_bits_and_pieces.pose_page_0.button_yoink"), e -> {
			if (BookcheatsshowProcedure.execute(entity)) {
				FnafBitsAndPiecesMod.PACKET_HANDLER.sendToServer(new PosePage0ButtonMessage(0, x, y, z));
				PosePage0ButtonMessage.handleButtonAction(entity, 0, x, y, z);
			}
		}) {
			@Override
		...
		imagebutton_pagecornerleft = new ImageButton(this.leftPos + -39, this.topPos + 143, 13, 14, 0, 0, 14, new ResourceLocation("fnaf_bits_and_pieces:textures/screens/atlas/imagebutton_pagecornerleft.png"), 13, 28, e -> {
			if (true) {
				FnafBitsAndPiecesMod.PACKET_HANDLER.sendToServer(new PosePage0ButtonMessage(1, x, y, z));
				PosePage0ButtonMessage.handleButtonAction(entity, 1, x, y, z);
			}
		});
		...
		imagebutton_pagecornerright = new ImageButton(this.leftPos + 205, this.topPos + 143, 13, 14, 0, 0, 14, new ResourceLocation("fnaf_bits_and_pieces:textures/screens/atlas/imagebutton_pagecornerright.png"), 13, 28, e -> {
			if (true) {
				FnafBitsAndPiecesMod.PACKET_HANDLER.sendToServer(new PosePage0ButtonMessage(2, x, y, z));
				PosePage0ButtonMessage.handleButtonAction(entity, 2, x, y, z);
			}
		});
