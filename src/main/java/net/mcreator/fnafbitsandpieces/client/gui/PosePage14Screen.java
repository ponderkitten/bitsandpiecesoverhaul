...
import net.mcreator.fnafbitsandpieces.network.PosePage14ButtonMessage;
...
public class PosePage14Screen extends AbstractContainerScreen<PosePage14Menu> {
	private final static HashMap<String, Object> guistate = PosePage14Menu.guistate;
	...
	public PosePage14Screen(PosePage14Menu container, Inventory inventory, Component text) {
	...
	private static final ResourceLocation texture = new ResourceLocation("fnaf_bits_and_pieces:textures/screens/pose_page_14.png");
	...
	protected void renderBg(PoseStack ms, float partialTicks, int gx, int gy) {
		...
		RenderSystem.setShaderTexture(0, new ResourceLocation("fnaf_bits_and_pieces:textures/screens/bookpose14.png"));
	...
	public void init() {
		...
		button_yoink = new Button(this.leftPos + 135, this.topPos + -4, 51, 20, Component.translatable("gui.fnaf_bits_and_pieces.pose_page_14.button_yoink"), e -> {
			if (BookcheatsshowProcedure.execute(entity)) {
				FnafBitsAndPiecesMod.PACKET_HANDLER.sendToServer(new PosePage14ButtonMessage(0, x, y, z));
				PosePage14ButtonMessage.handleButtonAction(entity, 0, x, y, z);
			}
		}) {
			@Override
		...
		imagebutton_pagecornerleft = new ImageButton(this.leftPos + -39, this.topPos + 143, 13, 14, 0, 0, 14, new ResourceLocation("fnaf_bits_and_pieces:textures/screens/atlas/imagebutton_pagecornerleft.png"), 13, 28, e -> {
			if (true) {
				FnafBitsAndPiecesMod.PACKET_HANDLER.sendToServer(new PosePage14ButtonMessage(1, x, y, z));
				PosePage14ButtonMessage.handleButtonAction(entity, 1, x, y, z);
			}
		});
		...
		imagebutton_pagecornerright = new ImageButton(this.leftPos + 205, this.topPos + 143, 13, 14, 0, 0, 14, new ResourceLocation("fnaf_bits_and_pieces:textures/screens/atlas/imagebutton_pagecornerright.png"), 13, 28, e -> {
			if (true) {
				FnafBitsAndPiecesMod.PACKET_HANDLER.sendToServer(new PosePage14ButtonMessage(2, x, y, z));
				PosePage14ButtonMessage.handleButtonAction(entity, 2, x, y, z);
			}
		});
