...
public class PosePage8Screen extends AbstractContainerScreen<PosePage8Menu> {
	private final static HashMap<String, Object> guistate = PosePage8Menu.guistate;
	...
	public PosePage8Screen(PosePage8Menu container, Inventory inventory, Component text) {
	...
	private static final ResourceLocation texture = new ResourceLocation("fnaf_bits_and_pieces:textures/screens/pose_page_8.png");
	...
	protected void renderBg(PoseStack ms, float partialTicks, int gx, int gy) {
		...
		RenderSystem.setShaderTexture(0, new ResourceLocation("fnaf_bits_and_pieces:textures/screens/bookpose8.png"));
