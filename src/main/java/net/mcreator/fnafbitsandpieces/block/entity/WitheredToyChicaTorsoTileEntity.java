...
public class WitheredToyChicaTorsoTileEntity extends RandomizableContainerBlockEntity implements IAnimatable, WorldlyContainer {
	public AnimationFactory factory = GeckoLibUtil.createFactory(this);
	private NonNullList<ItemStack> stacks = NonNullList.<ItemStack>withSize(9, ItemStack.EMPTY);
	private final LazyOptional<? extends IItemHandler>[] handlers = SidedInvWrapper.create(this, Direction.values());

	public WitheredToyChicaTorsoTileEntity(BlockPos pos, BlockState state) {
		super(FnafBitsAndPiecesModBlockEntities.WITHERED_TOY_CHICA_TORSO.get(), pos, state);
	}
	...
	public void registerControllers(AnimationData data) {
		data.addAnimationController(new AnimationController<WitheredToyChicaTorsoTileEntity>(this, "controller", 0, this::predicate));
		data.addAnimationController(new AnimationController<WitheredToyChicaTorsoTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
	...
	public Component getDefaultName() {
		return Component.literal("withered_toy_chica_torso");
	}
	...
	public Component getDisplayName() {
		return Component.literal("Withered Toy Chica Torso");
	}
