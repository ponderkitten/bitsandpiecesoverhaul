...
public class BrokenCatRightArmTileEntity extends RandomizableContainerBlockEntity implements IAnimatable, WorldlyContainer {
	public AnimationFactory factory = GeckoLibUtil.createFactory(this);
	private NonNullList<ItemStack> stacks = NonNullList.<ItemStack>withSize(9, ItemStack.EMPTY);
	private final LazyOptional<? extends IItemHandler>[] handlers = SidedInvWrapper.create(this, Direction.values());

	public BrokenCatRightArmTileEntity(BlockPos pos, BlockState state) {
		super(FnafBitsAndPiecesModBlockEntities.BROKEN_CAT_RIGHT_ARM.get(), pos, state);
	}
	...
	public void registerControllers(AnimationData data) {
		data.addAnimationController(new AnimationController<BrokenCatRightArmTileEntity>(this, "controller", 0, this::predicate));
		data.addAnimationController(new AnimationController<BrokenCatRightArmTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
	...
	public Component getDefaultName() {
		return Component.literal("broken_cat_right_arm");
	}
	...
	public Component getDisplayName() {
		return Component.literal("Broken Cat Right Arm");
	}
