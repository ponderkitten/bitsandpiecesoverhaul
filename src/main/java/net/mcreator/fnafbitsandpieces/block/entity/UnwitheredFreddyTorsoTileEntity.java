...
public class UnwitheredFreddyTorsoTileEntity extends RandomizableContainerBlockEntity implements IAnimatable, WorldlyContainer {
	public AnimationFactory factory = GeckoLibUtil.createFactory(this);
	private NonNullList<ItemStack> stacks = NonNullList.<ItemStack>withSize(9, ItemStack.EMPTY);
	private final LazyOptional<? extends IItemHandler>[] handlers = SidedInvWrapper.create(this, Direction.values());

	public UnwitheredFreddyTorsoTileEntity(BlockPos pos, BlockState state) {
		super(FnafBitsAndPiecesModBlockEntities.UNWITHERED_FREDDY_TORSO.get(), pos, state);
	}
	...
	public void registerControllers(AnimationData data) {
		data.addAnimationController(new AnimationController<UnwitheredFreddyTorsoTileEntity>(this, "controller", 0, this::predicate));
		data.addAnimationController(new AnimationController<UnwitheredFreddyTorsoTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
	...
	public Component getDefaultName() {
		return Component.literal("unwithered_freddy_torso");
	}
	...
	public Component getDisplayName() {
		return Component.literal("Unwithered Freddy Torso");
	}
