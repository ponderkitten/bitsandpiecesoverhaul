...
public class UnwitheredBonnieTorsoTileEntity extends RandomizableContainerBlockEntity implements IAnimatable, WorldlyContainer {
	public AnimationFactory factory = GeckoLibUtil.createFactory(this);
	private NonNullList<ItemStack> stacks = NonNullList.<ItemStack>withSize(9, ItemStack.EMPTY);
	private final LazyOptional<? extends IItemHandler>[] handlers = SidedInvWrapper.create(this, Direction.values());

	public UnwitheredBonnieTorsoTileEntity(BlockPos pos, BlockState state) {
		super(FnafBitsAndPiecesModBlockEntities.UNWITHERED_BONNIE_TORSO.get(), pos, state);
	}
	...
	public void registerControllers(AnimationData data) {
		data.addAnimationController(new AnimationController<UnwitheredBonnieTorsoTileEntity>(this, "controller", 0, this::predicate));
		data.addAnimationController(new AnimationController<UnwitheredBonnieTorsoTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
	...
	public Component getDefaultName() {
		return Component.literal("unwithered_bonnie_torso");
	}
	...
	public Component getDisplayName() {
		return Component.literal("Unwithered Bonnie Torso");
	}
