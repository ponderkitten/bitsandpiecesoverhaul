...
public class Endo01HeadBonnieTileEntity extends RandomizableContainerBlockEntity implements IAnimatable, WorldlyContainer {
	public AnimationFactory factory = GeckoLibUtil.createFactory(this);
	private NonNullList<ItemStack> stacks = NonNullList.<ItemStack>withSize(9, ItemStack.EMPTY);
	private final LazyOptional<? extends IItemHandler>[] handlers = SidedInvWrapper.create(this, Direction.values());

	public Endo01HeadBonnieTileEntity(BlockPos pos, BlockState state) {
		super(FnafBitsAndPiecesModBlockEntities.ENDO_01_HEAD_BONNIE.get(), pos, state);
	}
	...
	public void registerControllers(AnimationData data) {
		data.addAnimationController(new AnimationController<Endo01HeadBonnieTileEntity>(this, "controller", 0, this::predicate));
		data.addAnimationController(new AnimationController<Endo01HeadBonnieTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
	...
	public Component getDefaultName() {
		return Component.literal("endo_01_head_bonnie");
	}
	...
	public Component getDisplayName() {
		return Component.literal("Endo-01 Bonnie Head");
	}
