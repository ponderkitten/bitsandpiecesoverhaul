...
public class DinerChicaLeftLegTileEntity extends RandomizableContainerBlockEntity implements IAnimatable, WorldlyContainer {
	public AnimationFactory factory = GeckoLibUtil.createFactory(this);
	private NonNullList<ItemStack> stacks = NonNullList.<ItemStack>withSize(9, ItemStack.EMPTY);
	private final LazyOptional<? extends IItemHandler>[] handlers = SidedInvWrapper.create(this, Direction.values());

	public DinerChicaLeftLegTileEntity(BlockPos pos, BlockState state) {
		super(FnafBitsAndPiecesModBlockEntities.DINER_CHICA_LEFT_LEG.get(), pos, state);
	}
	...
	public void registerControllers(AnimationData data) {
		data.addAnimationController(new AnimationController<DinerChicaLeftLegTileEntity>(this, "controller", 0, this::predicate));
		data.addAnimationController(new AnimationController<DinerChicaLeftLegTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
	...
	public Component getDefaultName() {
		return Component.literal("diner_chica_left_leg");
	}
	...
	public Component getDisplayName() {
		return Component.literal("Diner Chica Left Leg");
	}
