...
public class AngledUnwitheredBonnieShowtimeTileEntity extends RandomizableContainerBlockEntity implements IAnimatable, WorldlyContainer {
	public AnimationFactory factory = GeckoLibUtil.createFactory(this);
	private NonNullList<ItemStack> stacks = NonNullList.<ItemStack>withSize(9, ItemStack.EMPTY);
	private final LazyOptional<? extends IItemHandler>[] handlers = SidedInvWrapper.create(this, Direction.values());

	public AngledUnwitheredBonnieShowtimeTileEntity(BlockPos pos, BlockState state) {
		super(FnafBitsAndPiecesModBlockEntities.ANGLED_UNWITHERED_BONNIE_SHOWTIME.get(), pos, state);
	}
	...
	public void registerControllers(AnimationData data) {
		data.addAnimationController(new AnimationController<AngledUnwitheredBonnieShowtimeTileEntity>(this, "controller", 0, this::predicate));
		data.addAnimationController(new AnimationController<AngledUnwitheredBonnieShowtimeTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
	...
	public Component getDefaultName() {
		return Component.literal("angled_unwithered_bonnie_showtime");
	}
