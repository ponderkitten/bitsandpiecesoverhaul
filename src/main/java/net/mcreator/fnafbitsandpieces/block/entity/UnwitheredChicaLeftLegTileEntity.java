...
public class UnwitheredChicaLeftLegTileEntity extends RandomizableContainerBlockEntity implements IAnimatable, WorldlyContainer {
	public AnimationFactory factory = GeckoLibUtil.createFactory(this);
	private NonNullList<ItemStack> stacks = NonNullList.<ItemStack>withSize(9, ItemStack.EMPTY);
	private final LazyOptional<? extends IItemHandler>[] handlers = SidedInvWrapper.create(this, Direction.values());

	public UnwitheredChicaLeftLegTileEntity(BlockPos pos, BlockState state) {
		super(FnafBitsAndPiecesModBlockEntities.UNWITHERED_CHICA_LEFT_LEG.get(), pos, state);
	}
	...
	public void registerControllers(AnimationData data) {
		data.addAnimationController(new AnimationController<UnwitheredChicaLeftLegTileEntity>(this, "controller", 0, this::predicate));
		data.addAnimationController(new AnimationController<UnwitheredChicaLeftLegTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
	...
	public Component getDefaultName() {
		return Component.literal("unwithered_chica_left_leg");
	}
	...
	public Component getDisplayName() {
		return Component.literal("Unwithered Chica Left Leg");
	}
