...
public class WitheredToyFreddyLeftLegTileEntity extends RandomizableContainerBlockEntity implements IAnimatable, WorldlyContainer {
	public AnimationFactory factory = GeckoLibUtil.createFactory(this);
	private NonNullList<ItemStack> stacks = NonNullList.<ItemStack>withSize(9, ItemStack.EMPTY);
	private final LazyOptional<? extends IItemHandler>[] handlers = SidedInvWrapper.create(this, Direction.values());

	public WitheredToyFreddyLeftLegTileEntity(BlockPos pos, BlockState state) {
		super(FnafBitsAndPiecesModBlockEntities.WITHERED_TOY_FREDDY_LEFT_LEG.get(), pos, state);
	}
	...
	public void registerControllers(AnimationData data) {
		data.addAnimationController(new AnimationController<WitheredToyFreddyLeftLegTileEntity>(this, "controller", 0, this::predicate));
		data.addAnimationController(new AnimationController<WitheredToyFreddyLeftLegTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
	...
	public Component getDefaultName() {
		return Component.literal("withered_toy_freddy_left_leg");
	}
	...
	public Component getDisplayName() {
		return Component.literal("Withered Toy Freddy Left Leg");
	}
