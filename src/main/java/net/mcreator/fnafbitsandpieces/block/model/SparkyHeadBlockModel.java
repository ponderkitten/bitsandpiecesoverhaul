...
public class SparkyHeadBlockModel extends AnimatedGeoModel<SparkyHeadTileEntity> {
	@Override
	public ResourceLocation getAnimationResource(SparkyHeadTileEntity animatable) {
		return new ResourceLocation("fnaf_bits_and_pieces", "animations/sparkyparts.animation.json");
	}

	@Override
	public ResourceLocation getModelResource(SparkyHeadTileEntity animatable) {
		return new ResourceLocation("fnaf_bits_and_pieces", "geo/sparkyparts.geo.json");
	}

	@Override
	public ResourceLocation getTextureResource(SparkyHeadTileEntity entity) {
