...
public class ChesterLeftArmBlockModel extends AnimatedGeoModel<ChesterLeftArmTileEntity> {
	@Override
	public ResourceLocation getAnimationResource(ChesterLeftArmTileEntity animatable) {
		return new ResourceLocation("fnaf_bits_and_pieces", "animations/chesterparts.animation.json");
	}

	@Override
	public ResourceLocation getModelResource(ChesterLeftArmTileEntity animatable) {
		return new ResourceLocation("fnaf_bits_and_pieces", "geo/chesterparts.geo.json");
	}

	@Override
	public ResourceLocation getTextureResource(ChesterLeftArmTileEntity entity) {
