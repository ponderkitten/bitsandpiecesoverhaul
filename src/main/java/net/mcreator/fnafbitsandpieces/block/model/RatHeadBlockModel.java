...
public class RatHeadBlockModel extends AnimatedGeoModel<RatHeadTileEntity> {
	@Override
	public ResourceLocation getAnimationResource(RatHeadTileEntity animatable) {
		return new ResourceLocation("fnaf_bits_and_pieces", "animations/ratparts.animation.json");
	}

	@Override
	public ResourceLocation getModelResource(RatHeadTileEntity animatable) {
		return new ResourceLocation("fnaf_bits_and_pieces", "geo/ratparts.geo.json");
	}

	@Override
	public ResourceLocation getTextureResource(RatHeadTileEntity entity) {
