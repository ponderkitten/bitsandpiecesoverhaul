...
public class CatRightLegBlockModel extends AnimatedGeoModel<CatRightLegTileEntity> {
	@Override
	public ResourceLocation getAnimationResource(CatRightLegTileEntity animatable) {
		return new ResourceLocation("fnaf_bits_and_pieces", "animations/catparts.animation.json");
	}

	@Override
	public ResourceLocation getModelResource(CatRightLegTileEntity animatable) {
		return new ResourceLocation("fnaf_bits_and_pieces", "geo/catparts.geo.json");
	}

	@Override
	public ResourceLocation getTextureResource(CatRightLegTileEntity entity) {
