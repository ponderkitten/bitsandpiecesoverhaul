...
public class DinerFoxyLeftLegBlockModel extends AnimatedGeoModel<DinerFoxyLeftLegTileEntity> {
	@Override
	public ResourceLocation getAnimationResource(DinerFoxyLeftLegTileEntity animatable) {
		return new ResourceLocation("fnaf_bits_and_pieces", "animations/dinerfoxyparts.animation.json");
	}

	@Override
	public ResourceLocation getModelResource(DinerFoxyLeftLegTileEntity animatable) {
		return new ResourceLocation("fnaf_bits_and_pieces", "geo/dinerfoxyparts.geo.json");
	}

	@Override
	public ResourceLocation getTextureResource(DinerFoxyLeftLegTileEntity entity) {
