...
public class CatHeadDisplayModel extends AnimatedGeoModel<CatHeadDisplayItem> {
	@Override
	public ResourceLocation getAnimationResource(CatHeadDisplayItem animatable) {
		return new ResourceLocation("fnaf_bits_and_pieces", "animations/catparts.animation.json");
	}

	@Override
	public ResourceLocation getModelResource(CatHeadDisplayItem animatable) {
		return new ResourceLocation("fnaf_bits_and_pieces", "geo/catparts.geo.json");
	}

	@Override
	public ResourceLocation getTextureResource(CatHeadDisplayItem entity) {
