...
public class BlankRightArmBlockModel extends AnimatedGeoModel<BlankRightArmTileEntity> {
	@Override
	public ResourceLocation getAnimationResource(BlankRightArmTileEntity animatable) {
		return new ResourceLocation("fnaf_bits_and_pieces", "animations/blankparts.animation.json");
	}

	@Override
	public ResourceLocation getModelResource(BlankRightArmTileEntity animatable) {
		return new ResourceLocation("fnaf_bits_and_pieces", "geo/blankparts.geo.json");
	}

	@Override
	public ResourceLocation getTextureResource(BlankRightArmTileEntity entity) {
