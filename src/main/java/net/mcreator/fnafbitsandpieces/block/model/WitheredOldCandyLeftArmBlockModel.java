...
public class WitheredOldCandyLeftArmBlockModel extends AnimatedGeoModel<WitheredOldCandyLeftArmTileEntity> {
	@Override
	public ResourceLocation getAnimationResource(WitheredOldCandyLeftArmTileEntity animatable) {
		return new ResourceLocation("fnaf_bits_and_pieces", "animations/oldcandyparts.animation.json");
	}

	@Override
	public ResourceLocation getModelResource(WitheredOldCandyLeftArmTileEntity animatable) {
