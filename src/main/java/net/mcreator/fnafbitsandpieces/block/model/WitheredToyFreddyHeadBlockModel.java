...
public class WitheredToyFreddyHeadBlockModel extends AnimatedGeoModel<WitheredToyFreddyHeadTileEntity> {
	@Override
	public ResourceLocation getAnimationResource(WitheredToyFreddyHeadTileEntity animatable) {
		return new ResourceLocation("fnaf_bits_and_pieces", "animations/witheredtoyfreddyparts.animation.json");
	}

	@Override
	public ResourceLocation getModelResource(WitheredToyFreddyHeadTileEntity animatable) {
		return new ResourceLocation("fnaf_bits_and_pieces", "geo/witheredtoyfreddyparts.geo.json");
	}

	@Override
	public ResourceLocation getTextureResource(WitheredToyFreddyHeadTileEntity entity) {
